...
public class Error_Pager_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public Error_Pager_Adapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.error_question_pager, parent,false);
